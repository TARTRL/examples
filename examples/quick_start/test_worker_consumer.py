...
'''
Worker and Consumer are two different classes, and they will execute in two different Pod, 
but Consumer can get data from Worker very easily.
'''

# Work is used for producing data.
class Worker:
...
# Consumer is used for receiving data produced by Worker
class Consumer:
